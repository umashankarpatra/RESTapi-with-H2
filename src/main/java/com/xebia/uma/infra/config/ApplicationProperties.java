package com.xebia.uma.infra.config;
...
public class ApplicationProperties {
    ...
    public static final String CONTROLLER_PACKAGE = "com.xebia.uma.controller";
    
    public static final String SERVICE_PACKAGE = "com.xebia.uma.service";
    
    public static final String REPOSITORY_PACKAGE = "com.xebia.uma.repository";
